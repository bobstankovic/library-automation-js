...
@lib-01-02
  ...
  Scenario Outline: Verify users can't login with invalid creadentials
    ...
    Examples:
      ...
      | user2@example.com | libraryPassword  |
    


@lib-01-03
# TODO: Verify users are not allowed to login without any credentials
Scenario: Verify users can't login without any credentials
